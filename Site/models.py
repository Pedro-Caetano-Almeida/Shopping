...
class Produto(models.Model):
    AVALIACAO = [
        (0, '0'), #primeiro é oq vai para o banco de dados e o segundo é o que vai aparecer na página 
        (1, '1'), 
        (2, '2'), 
        (3, '3'), 
        (4, '4'), 
    ...
    imagem = models.ImageField(upload_to='images/') #isso é para colocar uma foto
